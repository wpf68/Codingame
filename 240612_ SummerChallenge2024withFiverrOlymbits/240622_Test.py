...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2024/06/22 14:44:18 by pwolff            #+#    #+#              #
#    Updated: 2024/06/22 14:44:33 by pwolff           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
while True:
    ...
    for i in range(nb_games):
        ...
        cibleX.append(int(inputs[1 + player_idx]))
        cibleY.append(int(inputs[2 + player_idx]))

        if inputs[0] == "GAME_OVER..." or inputs[0] == "GAME_OVER" :
    ...
    if pos_player[0] < 15 and "#" in gpu[0][pos_player[0]:]: # and len(gpu[1]) > 2:
        print(pos_player[player_idx], gpu[0], file=sys.stderr, flush=True)
    ...
    # else:
    #     print("jeu cible ", gpu[1], file=sys.stderr, flush=True)
    #     if abs(cibleX[1]) > abs(cibleY[1]) and abs(cibleX[1]) > 5:
    #         if cibleX[1] > 0:
    #             print("LEFT")
    #         else:
    #             print("RIGHT")
    ...
    #     elif abs(cibleX[1]) < abs(cibleY[1]) and abs(cibleY[1]) > 5:
    #         if cibleY[1] > 0:
    #             print("UP")
    #         else:
    #             print("DOWN")
    ...
    print("CibleX = ", cibleX[1], abs(cibleX[1]), file=sys.stderr, flush=True)
    print("CibleY = ", cibleY[1], abs(cibleY[1]), file=sys.stderr, flush=True)
